...
import { Eraser, FileText, Hash, House, Image, Scissors, SquarePen, User } from 'lucide-react'

const navItems = [
    {to: '/ai', label: 'Dashboard', Icon: House},
    {to: '/ai/chat', label: 'Chat', Icon: SquarePen},
...
const Sidebar = ({sidebar,setSidebar}) => {
  ...
  return (
    <div className={`w-60 bg-white boreder-r border-gray-200 flex flex-col justify-between items-center
            ...
            <div className='my-7 w-full'>
                ...
                <div className='px-6 mt-5 text-sm text-black font-medium'>
                    ...
                    (
                        ...
                        className={({isActive})=>
                        `px-3.5 py-2.5 flex items-center gap-3 rounded ${isActive? 'bg-primary text-white' : '' }`}>
